        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="mb-4">Edit Company Information {{ $company->name }}</h3>
                    ...
                    <form method="POST" action="{{ route('companies.update', $company->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-4">
                                @if ($company->logo)
                                    <img id="logo-preview" src="{{ asset('storage/logos/' . $company->logo) }}" alt="Logo Preview"
                        ...
                        <x-primary-button type="submit">{{ __('Update Company') }}</x-primary-button>
                    </form>
                </div>
            </div>
        </div>
